...
const Interpassivity = (): React.ReactElement => {
  return (
    <div className="container">
      ...
      <div className="text">
        <p>
          Interpassivity reflects on today’s fast-paced world - the click bait, use-all, catch
        ...
        <p>
          ...
          test. Interpassivity is an elaboration on their findings, exploring the connections
