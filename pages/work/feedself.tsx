...
const Feedself = (): React.ReactElement => {
  return (
    <div className="container">
      ...
      <div className="text">
        <p>
          Feedself reflects on today’s fast-paced world - the click bait, use-all, catch phrase
        ...
        <p>
          ...
          test. Feedself is an elaboration on their findings, exploring the connections between the
