...
const Beeptext = (): React.ReactElement => {
  return (
    <div className="container">
      ...
      <div className="text">
        <p>
          Beeptext reflects on today’s fast-paced world - the click bait, use-all, catch phrase
        ...
        <p>
          ...
          test. Beeptext is an elaboration on their findings, exploring the connections between the
