...
const Dolls = (): React.ReactElement => {
  return (
    <div className="container">
      ...
      <div className="text">
        <p>
          Dolls reflects on today’s fast-paced world - the click bait, use-all, catch phrase
        ...
        <p>
          ...
          test. Dolls is an elaboration on their findings, exploring the connections between the
