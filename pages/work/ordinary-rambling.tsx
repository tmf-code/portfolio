...
const OrdinaryRambling = (): React.ReactElement => {
  return (
    <div className="container">
      ...
      <div className="text">
        <p>
          OrdinaryRambling reflects on today’s fast-paced world - the click bait, use-all, catch
          phrase littering self-help blogs and trendy articles. Reportedly things keep moving faster
          and in a straight line. In this world, we strive to “get on top of things”, and get ahead,
          or at least, keep up before we fall behind. Addressing these contemporary conceptions of
          time, the piece probes the interwoven notions of obligation and futility.
        </p>
        <p>
          ...
          test. OrdinaryRambling is an elaboration on their findings, exploring the connections
          between the pace-keeping dimension of technology and time.
        </p>
        <p>
